...
tf.app.flags.DEFINE_string('training_data_path', '/home/yulongwu/d/east_data/icdar2015_train_data/',
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                # print im_fn
                h, w, _ = im.shape
                label_tmp = os.path.basename(im_fn)
                new_label = 'gt_' + label_tmp.split('.')[0] + '.txt'
                txt_fn = im_fn.replace(label_tmp, new_label)
...
if __name__ == '__main__':
    # g = generator(input_size=512, batch_size=10, background_ratio=3. / 8, random_scale=np.array([0.8, 1, 2.0, 3.0]),
    #               vis=True)
    # next(g)
    g = generator(input_size=512, batch_size=5, background_ratio=3. / 8,
